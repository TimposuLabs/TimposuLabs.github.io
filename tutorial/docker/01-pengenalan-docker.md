...
1. **Build**: Ucup selesai menulis kode program Java dengan databasenya di laptopnya (development). Ia membungkus aplikasi tersebut ke dalam sebuah Docker Image dengan label versi: `ucupdev/java-api:1.0.2`.
